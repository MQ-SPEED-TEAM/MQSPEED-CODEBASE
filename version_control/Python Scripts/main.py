    ...
    while True:
        ...
        if GPIO.input(10) == GPIO.LOW:
            ...
            if (millis >(20*printed_times+time_start)):
                ...
                standard_overlay = '                                                                                                                                         Cadance: ' +str(round(sensor_data_processor.cr)) +'   KPH: ' +str(round(sensor_data_processor.ts))+ '   Gear: '+ str(round(sensor_data_processor.g)) + '                            '+'   Distance: ' + str(sensor_data_processor.dt) +'   Power: ' + str(round(sensor_data_processor.pr))+  ' Torque:  ' + str(round(sensor_data_processor.tq))+  
