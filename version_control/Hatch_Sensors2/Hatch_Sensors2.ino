...
double lat2 = 33.783516; // Destination latitude ----> // COME BACK AND REMEMBER TO CHANGE THIS 
double lon2 = 151.125982; // Destination longitude --> //  COME BACK AND REMEMBER TO CHANGE THIS
...
///
   ...
   if (GPS.fix) {
   double lat1 = GPS.latitude;
   double lon1 = GPS.longitude;
   Serial.print(lat1, 4); 
   Serial.print(", ");
   Serial.print(lon1, 4);
   Serial.print(", ");
   Serial.print(GetDistance(lat1,lon1,lat2,lon2));
   Serial.print("\n");
   Serial.flush();
    }else{
   Serial.print("\n");
...
//   Serial.println("abcdefghijklmnopqrstuvwxyz1234567890PLEASEWORKIBEGOFYOUTHANKYOUVERYMUCH");
//   Serial.flush();
/////
   
//   Serial.print("Fx: "); Serial.print((int)GPS.fix);
//   if (GPS.fix) {
//// NOTE: ORIENTATION ADJUSTMENT FOR BIKE: y axis <=> z axis
//   Serial.print("'ax':");
//   Serial.print(accel_event.acceleration.x, 2); 
//   Serial.flush();
//   Serial.print(",");
...
// BENCHMARK TESTING SERIAL COMMUNICATION
//Serial.print(millis());
//Serial.println("   ahskjfhjkahfkjasjkfhakshfkasjkfjkashfkjashkfhasjkfhkjashfkashjkfhjasfk");
