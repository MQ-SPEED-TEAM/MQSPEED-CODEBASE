...
while True:
    ...
    if GPIO.input(7) == GPIO.HIGH:
        ...
        line = ('{0}, {1}, {2}, {3}, {4}, {5}, {6}' .format(current_time, arduino_readings.main.wheel_left, arduino_readings.main.wheel_right, arduino_readings.main.wheel_centre, arduino_readings.main.gear,arduino_readings.main.Total_Speed, arduino_readings.main.error_response))
